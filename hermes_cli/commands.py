...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("voiceclone", "Curate local media into an inactive voice-clone audition workspace", "Configuration",
               gateway_only=True, aliases=("voice-clone", "vcfx"),
               args_hint="[name] [--target 01:23]", busy_policy="dispatch"),
